...
// Mode 1
void MoveItTeleop::enableTeleoperation()
{
...
void MoveItTeleop::setupInteractiveMarker()
{
  ...
  remote_control_->setInteractiveMarkerCallback(std::bind(
      &MoveItTeleop::processMarkerPose, this, std::placeholders::_1, std::placeholders::_2));
}

void MoveItTeleop::processMarkerPose(const geometry_msgs::Pose& pose, int mode)
{
